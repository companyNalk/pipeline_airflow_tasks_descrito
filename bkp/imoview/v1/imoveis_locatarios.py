...
API_URL_IMOVEIS = "https://api.imoview.com.br/Locatario/RetornarImoveis"
...
def main():
    ...
    if todos_imoveis:
        ...
        upload_to_gcs(csv_buffer.getvalue(), f"{FOLDER_NAME}/imoveis_imoview.csv")
