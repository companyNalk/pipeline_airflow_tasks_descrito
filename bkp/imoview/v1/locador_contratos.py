...
API_URL_CONTRATOS_LOCADOR = "https://api.imoview.com.br/Locador/RetornarContratos"
...
def main():
    ...
    if todos_contratos:
        ...
        upload_to_gcs(csv_buffer.getvalue(), f"{FOLDER_NAME}/contratos_locador_imoview.csv")
