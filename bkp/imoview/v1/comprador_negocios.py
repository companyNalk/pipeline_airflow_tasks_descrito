...
API_URL_NEGOCIOS_COMPRADOR = "https://api.imoview.com.br/Comprador/RetornarNegocios"
...
FOLDER_NAME = "comprador_negocios"
...
def main():
    ...
    if todos_negocios:
        ...
        upload_to_gcs(csv_buffer.getvalue(), f"{FOLDER_NAME}/negocios_comprador_imoview.csv")
