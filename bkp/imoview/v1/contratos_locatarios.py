...
API_URL_CONTRATOS = "https://api.imoview.com.br/Locatario/RetornarContratos"
...
FOLDER_NAME = "locatario_contratos"
...
def main():
    ...
    if todos_contratos:
        ...
        upload_to_gcs(csv_buffer.getvalue(), f"{FOLDER_NAME}/contratos_imoview.csv")
