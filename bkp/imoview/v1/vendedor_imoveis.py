...
API_URL_IMOVEIS_VENDEDOR = "https://api.imoview.com.br/Vendedor/RetornarImoveis"
...
def main():
    ...
    if todos_imoveis:
        ...
        upload_to_gcs(csv_buffer.getvalue(), f"{FOLDER_NAME}/imoveis_vendedor_imoview.csv")
